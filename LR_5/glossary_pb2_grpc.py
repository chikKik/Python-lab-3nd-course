...
class GlossaryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Home = channel.unary_unary(
                '/glossary.GlossaryService/Home',
                request_serializer=glossary__pb2.Empty.SerializeToString,
                response_deserializer=glossary__pb2.HomeResponse.FromString,
                _registered_method=True)
        self.GetAll = channel.unary_unary(
                '/glossary.GlossaryService/GetAll',
                request_serializer=glossary__pb2.Empty.SerializeToString,
                response_deserializer=glossary__pb2.GetAllResponse.FromString,
                _registered_method=True)
        self.GetTerm = channel.unary_unary(
                ...
                _registered_method=True)
        self.SearchTerm = channel.unary_unary(
                '/glossary.GlossaryService/SearchTerm',
                request_serializer=glossary__pb2.SearchTermRequest.SerializeToString,
                response_deserializer=glossary__pb2.SearchTermResponse.FromString,
                _registered_method=True)
...
def add_GlossaryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Home': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=glossary__pb2.HomeResponse.SerializeToString,
            ),
            'GetAll': grpc.unary_unary_rpc_method_handler(
                    servicer.GetAll,
                    request_deserializer=glossary__pb2.Empty.FromString,
                    response_serializer=glossary__pb2.GetAllResponse.SerializeToString,
            ),
            ...
            'SearchTerm': grpc.unary_unary_rpc_method_handler(
                    servicer.SearchTerm,
                    request_deserializer=glossary__pb2.SearchTermRequest.FromString,
                    response_serializer=glossary__pb2.SearchTermResponse.SerializeToString,
            ),
...
class GlossaryService(object):
    ...
    def Home(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            glossary__pb2.HomeResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetAll(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/glossary.GlossaryService/GetAll',
            glossary__pb2.Empty.SerializeToString,
            glossary__pb2.GetAllResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def SearchTerm(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/glossary.GlossaryService/SearchTerm',
            glossary__pb2.SearchTermRequest.SerializeToString,
            glossary__pb2.SearchTermResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
